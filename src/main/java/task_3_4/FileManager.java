...
public class FileManager {
    ...
    public static <T> void serializeObjects(List<T> objects, String entitiesCategory) throws IOException {
    ...
    public static <T> List<T> deserializeObjects(Class<T> type, String fileName) throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
